...
public class HashTableTester {
	...
	private static ArrayList<Song> initSongList() {
		...
		songs.add(new Song("hi", "Dareon", 2005));
		songs.add(new Song("The Burning ", "Tom O'Sevens", 2011));
		songs.add(new Song("T Ships", "Tom O'Sevens", 2011));
	...
	public static void main(String[] args) {
		...
		if (removedSong == null || !removedSong.getArtist().equals("King Crimson") || removedSong.getYear() != 1974
				|| retrievedSong != null) {
		...
		// System.out.println(songsByTom.get(0));
